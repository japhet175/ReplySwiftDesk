...
const Services = () => {
  ...
  return (
    <>
      {/* SEO and H1 for Google */}
      <Helmet>
        <title>Our Services - ReplySwiftDesk</title>
        <meta
          name="description"
          content="Explore our services: redesign, email marketing, digital marketing, social media management, and virtual support to boost your business."
        />
      </Helmet>

      {/* H1 (screen-reader only) */}
      <h1 className="sr-only">Our Services - ReplySwiftDesk</h1>
